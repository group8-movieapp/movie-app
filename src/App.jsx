...
function App() {
  ...
  // Tarkistetaan onko elokuva suosikeissa
  const isFavorite = (movieId) => {
    return favorites.some(fav => fav.movie_id === movieId)
  }

  // Lisää tai poista suosikeista
  ...
  // Jos elokuva on valittu, näytetään sen yksityiskohtanäkymä
  if (selectedMovie) {
    return (
      <div className="app">
        <Header page={page} setPage={setPage} user={user} onLogout={handleLogout} onDelete={handleDelete} />
  ...
  // Päänäkymä (Home) - välittää nyt onSelectMovie-funktion eteenpäin
  return (
    <div className="app">
      <Header page={page} setPage={setPage} user={user} onLogout={handleLogout} onDelete={handleDelete} />
